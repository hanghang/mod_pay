...
import com.github.hanghang.pay.alipay.util.httpClient.HttpProtocolHandler;
import com.github.hanghang.pay.alipay.util.httpClient.HttpRequest;
import com.github.hanghang.pay.alipay.util.httpClient.HttpResponse;
import com.github.hanghang.pay.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
   ...
   * @throws Exception
   */
  public static String sendPostInfo(Map<String, String> sParaTemp) throws UnsupportedEncodingException
                                                                                   {
      //待请求参数数组
      Map<String, String> sPara = buildRequestPara(sParaTemp);
   ...
   * @throws Exception
   */
  public static String refund_fastpay_by_platform_nopwd(Map<String, String> sParaTemp) throws UnsupportedEncodingException {
