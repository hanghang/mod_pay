package com.github.hanghang.pay;
...
public class Demo {
	...
	public String demo(Model model,HttpSession session) {
		...
		String show_url = "http://www.xxx.com/?order=123";
	...
	// 退款
	// test failed via:
	// curl "http://localhost:8090/work/pay/alipay/refund?trade_no=2013100259955699&total_money=0.01&out_trade_no=testorder_00001_6&description=description_blahblahblah"
